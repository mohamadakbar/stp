					...
					<div class="form-group">
						<div class="row">
							<div class="col-xs-8">
								...
								<select class="select2 form-control custom-select" id="matkul" name="matkul">
									<option value="">Select</option>
							...
							<div class="col-xs-3">
								...
								<select class="select2 form-control custom-select" id="semester" name="semester" style="width: 40%;">
								</select>
							</div>
						</div>
					</div>
	...
	$(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)
		$("#matkul").on('change',function(){
			...
			$.ajax({
				...
				url: "<?php echo base_url("jadwalkuliah/getSmt"); ?>", // Isi dengan url/path file php yang dituju
				data: {id_matkul : getValue}, // data yang akan dikirim ke file yang dituju
				dataType: "json",
				...
				error: function (xhr, ajaxOptions, thrownError) { // Ketika ada error
					...
					// console.log(getValue); // Munculkan alert error
				}
			});
		});

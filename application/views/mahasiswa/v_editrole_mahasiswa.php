	...
	<div class="col-md-6">
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title">Role Mahasiswa</h3>
			</div>
			<?php echo form_open_multipart('mahasiswa/updaterole') ?>
			<?php foreach ($mahasiswa as $mhs) { ?>
			<div class="box-body">
				<div class="form-group">
					<label for="nama">Nama</label>
					<input type="text" readonly class="form-control" name="nama" value="<?php echo $mhs->nama_mahasiswa; ?>">
				</div>
				<div class="form-group">
					<label for="nama">Kode Akses</label>
					<input type="text" readonly class="form-control" name="id_akses" value="<?php echo $mhs->id_akses; ?>">
				</div>
			</div>
			<?php } ?>
		</div>
